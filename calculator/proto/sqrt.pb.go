...
func (x *SqrtResponce) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SqrtResponce) ProtoMessage() {}

func (x *SqrtResponce) ProtoReflect() protoreflect.Message {
	mi := &file_sqrt_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SqrtResponce.ProtoReflect.Descriptor instead.
func (*SqrtResponce) Descriptor() ([]byte, []int) {
	return file_sqrt_proto_rawDescGZIP(), []int{1}
}

func (x *SqrtResponce) GetResult() float64 {
	if x != nil {
		return x.Result
	}
	return 0
...
var file_sqrt_proto_rawDesc = []byte{
	...
	0x26, 0x0a, 0x0c, 0x53, 0x71, 0x72, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x63, 0x65, 0x12,
	0x16, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x01, 0x52,
	0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x42, 0x20, 0x5a, 0x1e, 0x67, 0x72, 0x70, 0x63, 0x2d,
...
var file_sqrt_proto_goTypes = []interface{}{
	...
	(*SqrtResponce)(nil), // 1: calculator.SqrtResponce
}
