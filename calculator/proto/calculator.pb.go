...
func (x *CalculatorRequest) GetFirstNum() int32 {
	if x != nil {
		return x.FirstNum
	}
	return 0
...
func (x *CalculatorRequest) GetSecondNum() int32 {
	if x != nil {
		return x.SecondNum
	}
	return 0
...
type CalculatorResponce struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CalculatorResponce) Reset() {
	*x = CalculatorResponce{}
	if protoimpl.UnsafeEnabled {
...
func (x *CalculatorResponce) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CalculatorResponce) ProtoMessage() {}

func (x *CalculatorResponce) ProtoReflect() protoreflect.Message {
	mi := &file_calculator_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CalculatorResponce.ProtoReflect.Descriptor instead.
func (*CalculatorResponce) Descriptor() ([]byte, []int) {
	return file_calculator_proto_rawDescGZIP(), []int{1}
}

func (x *CalculatorResponce) GetSum() int32 {
	if x != nil {
		return x.Sum
	}
	return 0
...
var file_calculator_proto_rawDesc = []byte{
	...
	,
	...
	0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x63, 0x65, 0x12, 0x38,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x63, 0x65, 0x28, 0x01, 0x12, 0x3a, 0x0a, 0x03, 0x4d, 0x61, 0x78, 0x12,
	...
	0x61, 0x74, 0x6f, 0x72, 0x2e, 0x4d, 0x61, 0x78, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x63, 0x65,
	0x28, 0x01, 0x30, 0x01, 0x12, 0x39, 0x0a, 0x04, 0x53, 0x71, 0x72, 0x74, 0x12, 0x17, 0x2e, 0x63,
	...
	0x6f, 0x72, 0x2e, 0x53, 0x71, 0x72, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x63, 0x65, 0x42,
	0x20, 0x5a, 0x1e, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x70, 0x72, 0x61, 0x63, 0x74, 0x69, 0x63, 0x65,
...
var file_calculator_proto_goTypes = []interface{}{
	...
	(*CalculatorResponce)(nil), // 1: calculator.CalculatorResponce
	(*AvgRequest)(nil),         // 2: calculator.AvgRequest
	(*MaxRequest)(nil),         // 3: calculator.MaxRequest
	(*SqrtRequest)(nil),        // 4: calculator.SqrtRequest
	(*AvgResponce)(nil),        // 5: calculator.AvgResponce
	(*MaxResponce)(nil),        // 6: calculator.MaxResponce
	(*SqrtResponce)(nil),       // 7: calculator.SqrtResponce
}
var file_calculator_proto_depIdxs = []int32{
	0, // 0: calculator.CalculatorService.Calculate:input_type -> calculator.CalculatorRequest
	2, // 1: calculator.CalculatorService.Avg:input_type -> calculator.AvgRequest
	3, // 2: calculator.CalculatorService.Max:input_type -> calculator.MaxRequest
	4, // 3: calculator.CalculatorService.Sqrt:input_type -> calculator.SqrtRequest
	1, // 4: calculator.CalculatorService.Calculate:output_type -> calculator.CalculatorResponce
	5, // 5: calculator.CalculatorService.Avg:output_type -> calculator.AvgResponce
	6, // 6: calculator.CalculatorService.Max:output_type -> calculator.MaxResponce
	7, // 7: calculator.CalculatorService.Sqrt:output_type -> calculator.SqrtResponce
...
func file_calculator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_calculator_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CalculatorResponce); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
