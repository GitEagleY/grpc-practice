...
type AvgResponce struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Resilt float64 `protobuf:"fixed64,1,opt,name=resilt,proto3" json:"resilt,omitempty"`
}

func (x *AvgResponce) Reset() {
	*x = AvgResponce{}
	if protoimpl.UnsafeEnabled {
...
func (x *AvgResponce) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AvgResponce) ProtoMessage() {}

func (x *AvgResponce) ProtoReflect() protoreflect.Message {
	mi := &file_avg_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AvgResponce.ProtoReflect.Descriptor instead.
func (*AvgResponce) Descriptor() ([]byte, []int) {
	return file_avg_proto_rawDescGZIP(), []int{1}
}

func (x *AvgResponce) GetResilt() float64 {
	if x != nil {
		return x.Resilt
	}
	return 0
...
var file_avg_proto_rawDesc = []byte{
	...
	0x28, 0x05, 0x52, 0x03, 0x6e, 0x75, 0x6d, 0x22, 0x25, 0x0a, 0x0b, 0x41, 0x76, 0x67, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x63, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x69, 0x6c, 0x74,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x01, 0x52, 0x06, 0x72, 0x65, 0x73, 0x69, 0x6c, 0x74, 0x42, 0x20,
...
var file_avg_proto_goTypes = []interface{}{
	...
	(*AvgResponce)(nil), // 1: calculator.AvgResponce
}
