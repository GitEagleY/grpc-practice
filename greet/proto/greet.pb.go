...
func (x *GreetResponce) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GreetResponce) ProtoMessage() {}

func (x *GreetResponce) ProtoReflect() protoreflect.Message {
	mi := &file_greet_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GreetResponce.ProtoReflect.Descriptor instead.
func (*GreetResponce) Descriptor() ([]byte, []int) {
	return file_greet_proto_rawDescGZIP(), []int{1}
}

func (x *GreetResponce) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
var file_greet_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x63, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x01,
	...
	0x65, 0x65, 0x74, 0x2e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x63,
	...
	0x2e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x63, 0x65, 0x30, 0x01,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x63, 0x65, 0x28, 0x01, 0x12, 0x3e, 0x0a, 0x0d, 0x47, 0x72,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x63, 0x65, 0x28, 0x01, 0x30, 0x01, 0x12, 0x3e, 0x0a, 0x11, 0x47, 0x72,
	...
	0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x63, 0x65, 0x42, 0x1b, 0x5a, 0x19, 0x67, 0x72,
	0x70, 0x63, 0x2d, 0x70, 0x72, 0x61, 0x63, 0x74, 0x69, 0x63, 0x65, 0x2f, 0x67, 0x72, 0x65, 0x65,
...
var file_greet_proto_goTypes = []interface{}{
	...
	(*GreetResponce)(nil), // 1: greet.GreetResponce
}
var file_greet_proto_depIdxs = []int32{
	...
	1, // 5: greet.GreetService.Greet:output_type -> greet.GreetResponce
	1, // 6: greet.GreetService.GreetManyTimes:output_type -> greet.GreetResponce
	1, // 7: greet.GreetService.LongGreet:output_type -> greet.GreetResponce
	1, // 8: greet.GreetService.GreetEveryone:output_type -> greet.GreetResponce
	1, // 9: greet.GreetService.GreetWithDeadline:output_type -> greet.GreetResponce
