...
var file_greet_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x63, 0x65, 0x28, 0x01, 0x42, 0x1b, 0x5a, 0x19, 0x67, 0x72,
...
var file_greet_proto_depIdxs = []int32{
	...
	1, // 3: greet.GreetService.Greet:output_type -> greet.GreetResponce
	1, // 4: greet.GreetService.GreetManyTimes:output_type -> greet.GreetResponce
	1, // 5: greet.GreetService.LongGreet:output_type -> greet.GreetResponce
