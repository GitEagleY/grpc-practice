...
type GreetServiceClient interface {
	Greet(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponce, error)
	...
	GreetWithDeadline(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponce, error)
}
...
func (c *greetServiceClient) Greet(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponce, error) {
	out := new(GreetResponce)
...
func (x *greetServiceGreetManyTimesClient) Recv() (*GreetResponce, error) {
	m := new(GreetResponce)
...
type GreetService_LongGreetClient interface {
	...
	CloseAndRecv() (*GreetResponce, error)
	grpc.ClientStream
}
...
func (x *greetServiceLongGreetClient) CloseAndRecv() (*GreetResponce, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(GreetResponce)
...
func (x *greetServiceGreetEveryoneClient) Recv() (*GreetResponce, error) {
	m := new(GreetResponce)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *greetServiceClient) GreetWithDeadline(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponce, error) {
	out := new(GreetResponce)
...
type GreetServiceServer interface {
	Greet(context.Context, *GreetRequest) (*GreetResponce, error)
	...
	GreetWithDeadline(context.Context, *GreetRequest) (*GreetResponce, error)
...
func (UnimplementedGreetServiceServer) Greet(context.Context, *GreetRequest) (*GreetResponce, error) {
...
func (UnimplementedGreetServiceServer) GreetWithDeadline(context.Context, *GreetRequest) (*GreetResponce, error) {
...
func (x *greetServiceGreetManyTimesServer) Send(m *GreetResponce) error {
...
type GreetService_LongGreetServer interface {
	SendAndClose(*GreetResponce) error
...
func (x *greetServiceLongGreetServer) SendAndClose(m *GreetResponce) error {
	return x.ServerStream.SendMsg(m)
}
...
func (x *greetServiceGreetEveryoneServer) Send(m *GreetResponce) error {
	return x.ServerStream.SendMsg(m)
}
